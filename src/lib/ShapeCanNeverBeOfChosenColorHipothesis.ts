...
export class ShapeCanNeverBeOfChosenColorHipothesis extends AbstractHypothesis {
  private readonly _displayText: string = "jamais podem ser da cor";
  private readonly _id: string = "cant-be-of-chosen-color";
  ...
  validate(
    ...
    }s jamais podem ser da cor ${ENTITY_COLOR_TRANSLATIONS[color]} está ${
